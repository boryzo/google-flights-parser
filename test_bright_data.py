...
if not os.environ.get("BRIGHT_DATA_API_KEY"):
    pytest.skip(
        "BRIGHT_DATA_API_KEY is required for Bright Data integration tests.",
        allow_module_level=True,
    )


def _run_bright_data_test() -> None:
...
def test_bright_data_integration() -> None:
    _run_bright_data_test()
